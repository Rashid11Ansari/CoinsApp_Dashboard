                        ...
                        children=[
                            ...
                            dcc.Dropdown(
                                ...
                                options=[
                                    ...
                                    {"label": "Product features & origin", "value": "q1"},
                                    {"label": "Plant vs animal signal", "value": "q3"},
                                    {"label": "Component-only", "value": "q4"},
                                    {"label": "Product-only", "value": "q5"},
                                    {"label": "Ingredient contribution", "value": "q6"},
                                    {"label": "Enriched features", "value": "q7"},
                                    {"label": "Selective amp/att", "value": "q8"},
                                    {"label": "Shared vs unique", "value": "q9"},
                                    {"label": "Hepar–Hepeel driver", "value": "q10"},
                                ],
                                value="home",
                                maxHeight=420,
                                optionHeight=38,
